...
**TrackMania Telemetry Monitor (TM²)** is a tool for Microsoft Windows that displays real-time telemetry data
from the [TrackMania](https://www.trackmania.com/) racing game.

The application lists the sector and/or checkpoint times of a race in a table, supplemented by a few statistics.
...
The application does not log any data or perform any analyses.
Also no gauges or line graphs are displayed.
